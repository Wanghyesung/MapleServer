...
namespace W
{
	...
	void HorntailRightHand::UpdatePacket()
	{
	...
	void HorntailRightHand::seal_skill()
	{
		...
		BattleManager::HitchAbnormal(SceneManger::FindPlayerRandom(GetSceneID()), BattleManager::eAbnormalType::SealSkill);
	}
