...
// string name = 1;
inline void S_NEW_EXIT::clear_name() {
  name_.ClearToEmpty();
}
inline const std::string& S_NEW_EXIT::name() const {
  // @@protoc_insertion_point(field_get:Protocol.S_NEW_EXIT.name)
  return _internal_name();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void S_NEW_EXIT::set_name(ArgT0&& arg0, ArgT... args) {
 
 name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:Protocol.S_NEW_EXIT.name)
}
inline std::string* S_NEW_EXIT::mutable_name() {
  // @@protoc_insertion_point(field_mutable:Protocol.S_NEW_EXIT.name)
  return _internal_mutable_name();
}
inline const std::string& S_NEW_EXIT::_internal_name() const {
  return name_.Get();
}
inline void S_NEW_EXIT::_internal_set_name(const std::string& value) {
  
  name_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* S_NEW_EXIT::_internal_mutable_name() {
  
  return name_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* S_NEW_EXIT::release_name() {
  // @@protoc_insertion_point(field_release:Protocol.S_NEW_EXIT.name)
  return name_.Release(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
inline void S_NEW_EXIT::set_allocated_name(std::string* name) {
  if (name != nullptr) {
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArenaForAllocation());
  // @@protoc_insertion_point(field_set_allocated:Protocol.S_NEW_EXIT.name)
}
