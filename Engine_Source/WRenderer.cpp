...
//
//	//light
	std::vector<W::Light*> renderer::m_vecLights = {};
//	StructedBuffer* m_pLightsBuffer = nullptr;
//
	W::Camera* renderer::MainCamera = nullptr;
	W::Camera* renderer::UICamera = nullptr;
	std::vector<W::Camera*> renderer::m_vecCameras = {};
